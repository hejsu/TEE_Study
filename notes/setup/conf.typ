...
#let project(title: "", body, language: "en", title_page: false, compat_title_page: false, author: "suspen") = {
  ...
  if title_page {
    ...
    align(center)[
      ...
      #link("https://github.com/shusoyo")[#raw(author)]
